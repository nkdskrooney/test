...
public class MyPageDAO {
	private DBConnector dbConnecor = new DBConnector();
	private Connection connection = dbConnecor.getConnection();
	...
	throws SQLException {
		String sql ="DELETE FROM user_buy_item_transaction WHERE item_transaction_id = ? AND user_master_id = ?”;PreparedStatement preparedStatement";
		int result = 0;
		try {
